...
class TRUBLDirector:
    ...
    def make_tr_ubl_invoice(self) -> None:
        ...
        self.builder.build_copyindicator()
        self.builder.build_issuedate()
        self.builder.build_issuetime()
        self.builder.build_invoicetypecode()
        self.builder.build_note()
        self.builder.build_documentcurrencycode()
        self.builder.build_taxcurrencycode()
        self.builder.build_pricingcurrencycode()
        self.builder.build_paymentcurrencycode()
        self.builder.build_paymentalternativecurrencycode()
        self.builder.build_accountingcost()
        self.builder.build_linecountnumeric()
