...
class Dimension(AbstractXMLFileState):
    ...
    def define_mappings(self):
        ...
        # Seçimli(0..1): Measure
        self._mapping['Measure'] = ('cbc', '', 'Seçimli (0...1)', False, False, True)
        # Seçimli(0..n): Description
        self._mapping['Description'] = ('cbc', '', 'Seçimli(0..n)', False, False, True)
        # Seçimli(0..1): MinimumMeasure
        self._mapping['MinimumMeasure'] = ('cbc', '', 'Seçimli(0..1)', False, False, True)
        # Seçimli(0..1): MaximumMeasure
        self._mapping['MaximumMeasure'] = ('cbc', '', 'Seçimli(0..1)', False, False, True)
